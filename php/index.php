...
<body>
    ...
    <div class="home">
        ...
        <div class="home-text">
            <h1>I'm</h1>
            <h1><span style="color: blue;font-weight: bold">Madara Meegama</span></h1>
            <h1>Software Engineering Undergraduate</h1>
    ...
    <section id="about">
        ...
        <h1>
        I am Madara Meegama, currently pursuing Software Engineering at SLIIT and Information Systems at the University of Colombo School of Computing. My academic journey has equipped me with a solid foundation in technologies such as HTML, CSS, PHP, JavaScript, Java, JavaFX, Kotlin, and the MERN stack. Additionally, I possess a strong understanding of Information Security, Networking, and fundamental knowledge of DevOps. My passion lies in solving real-world problems through innovative software solutions.
        </h1>
        <br>

        <h1>
        The opportunity to pursue a double degree has broadened my exposure to diverse disciplines, including management, digital marketing, and business process management. Beyond academics, this experience has enriched my personal growth, teaching me to balance responsibilities, manage stress effectively, and meet deadlines efficiently.
        </h1>
        <br>

        <h1>
        As an undergraduate, I have also actively volunteered for various events, which has strengthened my teamwork and organizational skills. I am now eager to embark on an internship to further hone my abilities and contribute meaningfully to a dynamic organization.
        </h1>
        <br>
